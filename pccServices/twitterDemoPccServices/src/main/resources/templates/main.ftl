    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-left">
          <li><a href="https://github.com/crawles/twitter-nlp">Source (GitHub)</a></li>
      ...
      <div class="col-sm-3">
        <div class="chart-wrapper">
                  <div class="chart-title container-fluid">
                      <div class="col-sm-6" style="font-size:20px">Selected Tweets</div>
        ...
        <p class="small text-muted"><a href="https://pivotal.io/data-science">Pivotal Data Science</a> 2016</p>
